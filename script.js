document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      doc.text("Skin Cupid", 20, y); y += lineHeight;
  ...
  function afterDownloadSuccess(data) {
    try {
      ...
      if (emailLink) {
        ...
        emailLink.href = `mailto:skincupid.collaboration@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(bodyPlain)}`;
